...
@Autonomous(name = "Backstage parking (HW) - BLUE, furthest from backstage, right of blue backstage", group = "Parking")
public class ParkBlueFarRight extends LinearOpMode {
    @Override
